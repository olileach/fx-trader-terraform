...
if __name__ == '__main__':
    ...
    parser.add_argument("-v", "--max-volume", help="max volume", default=100)
    parser.add_argument("-f", "--max-frequency", help="max frequency", default=15)
